...
def api_generate_text():
    ...
    html_note = "Для жирного текста используй HTML теги <b>текст</b>, НЕ markdown **текст**."
    prompts = {
        "expert": f"Ты врач-нутрициолог. Напиши экспертный пост для Telegram канала о здоровье и натуральных добавках. Тема: {topic or 'польза витаминов'}. Используй <b>жирный текст</b> для акцентов. 3-4 абзаца. В конце призыв перейти на {SHOP_LINK}. {html_note}",
        "viral": f"Напиши вирусный пост для Telegram о здоровье. Начни с шокирующего факта. Тема: {topic or 'здоровое питание'}. Используй <b>жирный</b>. Призыв к действию в конце. {html_note}",
        "sales": f"Напиши продающий пост для Telegram о натуральном продукте. Продукт/тема: {topic or 'витамины'}. Преимущества, отзывы, призыв купить на {SHOP_LINK}. Используй <b>жирный</b>. {html_note}",
        "faq": f"Напиши пост в формате вопрос-ответ для Telegram канала о здоровье. Тема: {topic or 'витамин D'}. Начни с вопроса, дай развёрнутый ответ. Используй <b>жирный</b>. {html_note}",
        "lifestyle": f"Напиши пост о здоровом образе жизни для Telegram. Тема: {topic or 'утренние ритуалы'}. Вдохновляющий тон. Используй <b>жирный</b>. {html_note}",
        "partner": f"Напиши пост о партнёрской программе Perfect Organic. Преимущества: пассивный доход, натуральные продукты, поддержка. Ссылка: {SHOP_LINK}. Используй <b>жирный</b>. {html_note}",
        "review": f"Напиши реалистичный отзыв покупателя натуральных добавок. Тема: {topic or 'витамины'}. От лица покупателя. 2-3 предложения. {html_note}",
    }
