...
def api_generate_text():
    ...
    html_note = "ВАЖНО: для жирного текста используй ТОЛЬКО HTML теги <b>текст</b>, НЕ markdown **текст**. Никаких символов * в тексте."
    prompts = {
        "expert": f"Ты врач-нутрициолог. Напиши экспертный пост для Telegram канала о здоровье и натуральных добавках. Тема: {topic or 'польза витаминов'}. 3-4 абзаца, 160-180 слов. В конце призыв перейти на {SHOP_LINK}. {html_note}",
        "viral": f"Напиши вирусный пост для Telegram о здоровье. Начни с шокирующего факта. Тема: {topic or 'здоровое питание'}. 160-180 слов. Призыв к действию в конце. {html_note}",
        "sales": f"Напиши продающий пост для Telegram о натуральном продукте. Продукт/тема: {topic or 'витамины'}. Преимущества, отзывы, призыв купить на {SHOP_LINK}. 160-180 слов. {html_note}",
        "faq": f"Напиши пост в формате вопрос-ответ для Telegram канала о здоровье. Тема: {topic or 'витамин D'}. Начни с вопроса, дай развёрнутый ответ. 160-180 слов. {html_note}",
        "lifestyle": f"Напиши пост о здоровом образе жизни для Telegram. Тема: {topic or 'утренние ритуалы'}. Вдохновляющий тон. 160-180 слов. {html_note}",
        "partner": f"Напиши пост о партнёрской программе Perfect Organic. Преимущества: пассивный доход, натуральные продукты, поддержка. Ссылка: {SHOP_LINK}. 160-180 слов. {html_note}",
